...
class FactorAtt_ConvRelPosEnc(nn.Module):
    ...
    def forward(self, x, size):
        ...
        # k_softmax_T_dot_v1 = einsum("b h n k, b h n v -> b h k v", k_softmax, v)
        k_softmax_T_dot_v = k_softmax.transpose(-2, -1) @ v
        # print(k_softmax_T_dot_v == k_softmax_T_dot_v1)
        # factor_att1 = einsum("b h n k, b h k v -> b h n v", q,
        #                     k_softmax_T_dot_v)
        factor_att = q @ k_softmax_T_dot_v
        # print(factor_att1 == factor_att)
        # Convolutional relative position encoding.
